...
namespace Quester
{
    public static class UIExtension
    {
        ...
        {
            uiComponent.CloseUIForm(GetUIForm(uiComponent, uiFormId));
        }
        ...
        public static void OpenForceUpdateDialog(this UIComponent uiComponent, Action<object> confirm)
        {
            DialogParams dialogParams = new DialogParams()
            {
                Mode = 1,
                Title = "#tips",
                Message = GameEntry.Localization.GetString("#force_update"),
                OnClickConfirm = confirm
            };
            GameEntry.UI.OpenDialog(dialogParams);
        }
        
        public static void OpenNetworkErrorDialog(this UIComponent uiComponent, Action<object> confirm)
        {
            DialogParams dialogParams = new DialogParams()
            {
                Mode = 1,
                Title = "#tips",
                Message = GameEntry.Localization.GetString("#network_check_tips"),
                OnClickConfirm = confirm
            };
            GameEntry.UI.OpenDialog(dialogParams);
        }
