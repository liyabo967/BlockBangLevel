...
namespace Quester
{
    public static class SoundExtension
    {
        ...
        public static int? PlayMusic(this SoundComponent soundComponent, MusicId musicId)
        {
            return PlayMusic(soundComponent, (int)musicId);
        }
        ...
        {
            return PlaySound(soundComponent, (int)soundId);
        }
        ...
        public static int? PlaySound(this SoundComponent soundComponent, int soundId, Entity bindingEntity = null, object userData = null)
        {
            ...
            return soundComponent.PlaySound(AssetUtility.GetSoundAsset(drSound.AssetName), "Sound", Constant.AssetPriority.SoundAsset, playSoundParams, null, userData);
        }
